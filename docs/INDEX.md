...
| `failure-tracking.md`                           | Active              | 2026-09-18   | Known failures and fixes, one entry per defect (FT-001 through FT-026). Latest: FT-026 `Model called unknown tool .` aborts the loop (open, deferred). FT-025 Noop silent-overflow compact escalated to last-resort |
