...
| `failure-tracking.md`                           | Active              | 2026-09-13   | Known failures and fixes, one entry per defect (FT-001 through FT-025). Latest: FT-025 Noop silent-overflow compact escalated to last-resort. FT-024 stale length-stop e2e assertion |
