...
| `tui_feature_requests_from_human.md`          | Active              | 2026-09-05   | Slim index of user feature requests on the tui. One line per request. Each item links its detail doc                                                            |
