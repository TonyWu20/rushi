...
| `refinement-policy.md`                        | Active              | 2026-09-15   | Rules for changing the harness: evidence bar, trigger thresholds, not-yet list. P1c/G3 event-type criteria now point at the typed `Event` vocabulary (the `schemas/events/v1/` JSON files were retired 2026-09-15) |
